...
#importar dados
dataset = pd.read_csv("C:/Users/Carlo/Documents/Projetos/PUC Minas - Projeto Churn/Destino/2-CHURN_PERFIL_ENRIQUECIDO.csv", sep=";")
...
dataset.to_csv('C:/Users/Carlo/Documents/Projetos/PUC Minas - Projeto Churn/Destino/PERFIL_CHURN_TRATADO.csv', index=False, sep=";")
